...
CREATE TABLE public.businesses (
  ...
  sms_template_add TEXT NOT NULL DEFAULT 'Hi {name}, you are number {position} in the queue at {business}. Estimated wait: {wait} minutes. We will alert you when you are close.',
  sms_template_call TEXT NOT NULL DEFAULT 'Hi {name}, it is your turn at {business}. Please come in now.',
  sms_template_headsup TEXT NOT NULL DEFAULT 'Hi {name}, you are 3rd in line at {business}. Please start making your way back now.',
...
CREATE TABLE public.queue_entries (
  ...
  headsup_sent BOOLEAN NOT NULL DEFAULT FALSE
);
...
CREATE POLICY "Owner inserts staff" ON public.staff_profiles FOR INSERT
